...
class ArgentineView extends StatefulWidget {
  const ArgentineView ({Key? key}) : super(key: key);

  @override
  State<ArgentineView> createState() => _ArgentineViewState();
}

class _ArgentineViewState extends State<ArgentineView> {
  var databody;
